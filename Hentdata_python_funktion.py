def hent_data(xml_url, geo_kreds = "Storkredse", stemmer = "parti"):
  ...
  if stemmer == "Person":
  ## Ændrer for dem på Bornholm, der kommer sjovt ud af json_normalise
    data_stemmer["Navn"] = data_stemmer["Navn"].fillna(data_stemmer["PersonNavn"])
    
    data_stemmer["PersonligeStemmer"] = data_stemmer["PersonligeStemmer"].fillna(data_stemmer["PersonPersonligeStemmer"])
    data_stemmer["TildeltePartiStemmer"] = data_stemmer["TildeltePartiStemmer"].fillna(data_stemmer["PersonTildeltePartiStemmer"])
    data_stemmer["StemmerIAlt"] = data_stemmer["StemmerIAlt"].fillna(data_stemmer["PersonStemmerIAlt"])
    
    ## Kandidater udenfor partierne
    data_stemmer["Navn"] = data_stemmer["Navn"].fillna(data_stemmer["navn"])
    
    data_stemmer["PersonligeStemmer"] = data_stemmer["PersonligeStemmer"].fillna(data_stemmer["PersonligeStemmerParti"])
    data_stemmer["TildeltePartiStemmer"] = data_stemmer["TildeltePartiStemmer"].fillna(data_stemmer["TildeltePartiStemmerParti"])
    data_stemmer["StemmerIAlt"] = data_stemmer["StemmerIAlt"].fillna(data_stemmer["StemmerIAltParti"])
  exit

  # Fjerner variable
  data_stemmer.drop(["Person", "PersonNavn", "PersonPersonligeStemmer", "PersonTildeltePartiStemmer", "PersonStemmerIAlt"], axis = 1, inplace = True, errors = "ignore")
